...
CLS_MODEL_PATH = BASE_DIR / "Classify" / "yolo_cls_weights" / "yolov8s-cls_colour_0612_012918" / "weights" / "best.pt"
...
_match = re.search(r'yolov8s-cls_colour_([\d_]+)', str(CLS_MODEL_PATH))
